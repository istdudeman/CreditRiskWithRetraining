...
for i in range(2000):
    data = {
        ...
        'stability': random.choice(['Pemasukan stabil per bulan', 'Pemasukan tidak stabil per bulan']),
        ...
        'loan_amount': random.choice([5000000, 10000000, 50000000, 100000000]),
        'term_months': random.choice([6, 12, 24, 36, 48, 60])
    }
    
    req_data = data.copy()
    req_data['income_stability'] = 1.0 if req_data['stability'] == 'Pemasukan stabil per bulan' else 0.0
